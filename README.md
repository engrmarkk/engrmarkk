...
- 🌱 I recently graduated from AltSchool Africa's Backend Engineering program and have gained skills in HTML, CSS, Bootstrap, JavaScript, Python, Flask, Django, SQLite, PostgreSQL, MongoDB, and REST API.
